...
impl BilibiliApi {
    ...
    pub async fn download_all_comments(
        ...
        comments::download_all_comments(aid, bvid, save_path, download_avatars, delay_seconds, sessdata).await
    }
    ...
    {
        comments::download_comments_to_file_with_progress(aid, csv_file_path, delay_seconds, sessdata, progress_callback).await
    }
